...
public class TS0006_CreateAccEmailFormat1 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void tS0006_CreateAccEmailFormat1() {
                ...
                allOf(withId(R.id.input_email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("nattapongchai"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.input_email), withText("nattapongchai"),
                        childAtPosition(
                                childAtPosition(
