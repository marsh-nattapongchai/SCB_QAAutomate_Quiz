...
public class TS0002_CreatAccNameLessThan3Char {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void tS0002_CreatAccNameLessThan3Char() {
                ...
                allOf(withId(R.id.input_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("Mu"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.input_name), withText("Mu"),
                        childAtPosition(
                                childAtPosition(
