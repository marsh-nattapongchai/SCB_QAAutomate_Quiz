...
public class TS0005_CreateAccAddressSuccess {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void tS0005_CreateAccAddressSuccess() {
                ...
                allOf(withId(R.id.input_address),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText2.perform(scrollTo(), replaceText("Bang"), closeSoftKeyboard());
