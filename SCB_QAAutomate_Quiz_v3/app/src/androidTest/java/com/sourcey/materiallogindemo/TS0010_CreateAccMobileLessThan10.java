...
public class TS0010_CreateAccMobileLessThan10 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void tS0010_CreateAccMobileLessThan10() {
                ...
                allOf(withId(R.id.input_mobile),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText4.perform(scrollTo(), replaceText("062222"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.input_mobile), withText("062222"),
                        childAtPosition(
                                childAtPosition(
